                ...
                if run == True:
                  ...
                  while(True):
                      ...
                      for face in faces:
                          ...
                          cv2.drawContours(frame, [leftEyeHull], -1, (195, 255, 70), 1)
                          ...
                          if(eyeAspectRatio < EYE_ASPECT_RATIO_THRESHOLD):
                              ...
                              if COUNTER >= EYE_ASPECT_RATIO_CONSEC_FRAMES:
                                  ...
                                  engine.say("Hey Man!! What are you doing?")
                                  engine.runAndWait()
    ...
    <nav class="navbar navbar-expand-lg bg-light" style="background-color: #33FFFF00">
      <div class="container-fluid" style="background-color: #33FFFF">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" style="color: Green; font-weight: bold; margin-right: 20px;">@--______We are Presenting Drowsiness Detecting  based on Camera Sensor ____--</a>
            </li>
          </ul>
        </div>
      </div>
