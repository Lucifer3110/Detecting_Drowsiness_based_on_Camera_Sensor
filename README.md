...
1.	First of all  this GitHub repository on the local system by using  this command, if there is any difficulty to run the command on local system then just download the zip file from GitHub and extract it into any empty folder.
...
streamlit run Detecting_Drowsiness.py
